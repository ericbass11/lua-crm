# Como subir o seu LUA CRM na HostGator (passo a passo, sem enrolação)
...
```
Seu domínio  →  Servidor VPS (HostGator)  →  LUA CRM rodando
                        │
                        ├─ o CRM (site + painel)
...
O LUA CRM roda num **VPS com Docker**. A opção mais fácil é um VPS que **já vem
...
2. Escreva pra ele exatamente isto:
   ...
   > *"Clone https://github.com/ericbass11/lua-crm e me instale o LUA CRM
...
O LUA CRM foi desenhado pra rodar redondo na infraestrutura da HostGator. Além do

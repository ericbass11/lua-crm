...
ultima_versao_publicada() {
  local url="${1:-https://github.com/ericbass11/lua-crm.git}" ref
...
# procura o namespace contíguo definido em IMG_NS, e a URL do token separa
# registry e owner para consultar o pacote correspondente.
ghcr_status() {

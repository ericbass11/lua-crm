...
TMP_PRIV="$(mktemp -d)"
(
  # A decisão exercitada abaixo precisa de uma versão publicada conhecida.
  # Usar o GitHub aqui tornava a prova dependente da rede: offline,
  # `ultima_versao_publicada` devolve vazio e o instalador segue corretamente
  # pelo ramo de `latest`, sem chegar ao fallback de build que este cenário
  # pretende medir.

...

{
  ...
  # Este é o nome que a imagem do WAHA realmente lê. `WAHA_DEFAULT_ENGINE`
  # parece plausível, mas é ignorado silenciosamente e deixa o engine voltar
  # para WEBJS depois de uma reinstalação.

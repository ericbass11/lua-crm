...
Use o [relato privado de vulnerabilidades do GitHub](https://github.com/ericbass11/lua-crm/security/advisories/new) — o relato chega só aos mantenedores, e o histórico fica auditável.

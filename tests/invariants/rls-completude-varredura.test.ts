...
const PROVA_PROPRIA: readonly Excecao[] = [
  {
    ...
    razao:
      "tests/invariants/fork-rls-isolation.test.ts (fork LUA CRM) prova isolamento " +
      "cross-tenant com JWT simulado E o gate de papel da migration 0918 (agent lê, " +
      "não escreve; manager escreve). Fica fora de TABLES porque o seed é da fork — " +
      "misturá-lo ao arquivo do upstream cria conflito a cada sincronização.",
  },
  {
    tabela: "followup_settings",
    razao:
      "tests/invariants/fork-rls-isolation.test.ts (fork LUA CRM) prova isolamento " +
      "cross-tenant com JWT simulado E o gate de papel da migration 0918 (agent lê, " +
      "não escreve; manager escreve). Fica fora de TABLES porque o seed é da fork — " +
  ...
  {
    tabela: "mystery_shopper_campaigns",
    razao:
      "tests/invariants/fork-rls-isolation.test.ts (fork LUA CRM) prova isolamento " +
      "cross-tenant com JWT simulado E o gate de papel da migration 0918 (agent lê, " +
      "não escreve; manager escreve). Fica fora de TABLES porque o seed é da fork — " +
  ...
  {
    tabela: "mystery_shopper_messages",
    razao:
      "tests/invariants/fork-rls-isolation.test.ts (fork LUA CRM) prova isolamento " +
      "cross-tenant com JWT simulado E o gate de papel da migration 0918 (agent lê, " +
      "não escreve; manager escreve). Fica fora de TABLES porque o seed é da fork — " +

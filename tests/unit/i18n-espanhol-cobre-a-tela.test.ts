...
const FORA_DO_PRODUTO: Record<string, string> = {
  "app/app/mystery": "extensão desta instalação (fork LUA CRM), em pt-BR por decisão de produto; a tradução do módulo é pendência declarada — sem cobertura em espanhol ainda",
  "app/app/settings/integrations": "extensão desta instalação (fork LUA CRM), em pt-BR por decisão de produto; a tradução do módulo é pendência declarada — sem cobertura em espanhol ainda",
  "app/app/settings/followup": "extensão desta instalação (fork LUA CRM), em pt-BR por decisão de produto; a tradução do módulo é pendência declarada — sem cobertura em espanhol ainda",
  "app/app/settings/tags": "extensão desta instalação (fork LUA CRM), em pt-BR por decisão de produto; a tradução do módulo é pendência declarada — sem cobertura em espanhol ainda",
  "app/app/settings/notifications/_components/HandoffWebhookCard.tsx": "extensão desta instalação (fork LUA CRM), em pt-BR por decisão de produto; a tradução do módulo é pendência declarada — sem cobertura em espanhol ainda",
  "app/app/dashboard": "extensão desta instalação (fork LUA CRM), em pt-BR por decisão de produto; a tradução do módulo é pendência declarada — sem cobertura em espanhol ainda",
  "components/inbox/NewConversationDialog.tsx": "extensão desta instalação (fork LUA CRM), em pt-BR por decisão de produto; a tradução do módulo é pendência declarada — sem cobertura em espanhol ainda",
  "components/tags/TagPicker.tsx": "extensão desta instalação (fork LUA CRM), em pt-BR por decisão de produto; a tradução do módulo é pendência declarada — sem cobertura em espanhol ainda",
  "components/ai/FaqEditorDialog.tsx": "extensão desta instalação (fork LUA CRM), em pt-BR por decisão de produto; a tradução do módulo é pendência declarada — sem cobertura em espanhol ainda",

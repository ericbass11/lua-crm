...
const REMOCOES_DELIBERADAS: Record<string, { valores: string[]; porque: string }> = {
  ...
  // Na fork Lua CRM o timestamp original 20260722160000 pertence ao bucket do
  // Cliente Oculto (0910). A migration upstream 0062 foi deslocada em dois
  // segundos para manter as duas identidades no histórico do Supabase.
  "20260722160002_0062_conversation_snooze.sql::agent_inbox_items_kind_check": {

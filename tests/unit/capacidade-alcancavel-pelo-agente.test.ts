...
const ESCRITA_QUE_E_TRABALHO_DE_ATENDENTE: ReadonlyArray<string> = [
  ...
  "crm_manage_tags",
  // Marcar a conversa e atualizar o cartão são trabalho operacional do agente;
  // os dois handlers exigem `agent` e só alteram dados reversíveis na tela.
  "crm_tag_conversation",
  "crm_set_lead_fields",
  // A integração da agenda é configurada por admin, mas marcar, remarcar e
  // cancelar o compromisso confirmado com o cliente é trabalho de atendimento.
  "crm_schedule_meeting",
  "crm_reschedule_meeting",
  "crm_cancel_meeting",
];

...
// Teste unitário nunca deve chamar o Redis configurado na máquina do
// desenvolvedor. O limitador já tem fallback em memória, que é determinístico
// e é justamente o caminho exercitado pela suíte.
...
for (const chave of VARIAVEIS_EXTERNAS_DESATIVADAS) process.env[chave] = "";

 ...
 *
 * 25 era o menor passo no catálogo upstream. O fork Lua CRM preserva também
 * `crm_set_lead_fields` no pacote de vendas e sua agenda por Service Account;
 * com essas capacidades exclusivas, 26 é o MENOR valor que deixa o agente do
 * onboarding ganhar ao menos uma segunda jornada. Não é número redondo
 * escolhido no olho — o teste deriva a conta do catálogo real e reprova se ele
 * voltar a formar um beco sem saída.
 *

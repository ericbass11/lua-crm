...
export const DICIONARIO: Traducoes = {
  ...
  "Cliente Oculto": { es: "Cliente oculto" },
  Configurações: { es: "Configuración" },
  "Follow-up automático": { es: "Seguimiento automático" },
  "Agenda Google": { es: "Agenda de Google" },
  "Tags de conversa": { es: "Etiquetas de conversación" },
  ...
  // ─── Extensões desta instalação (fork LUA CRM): Nota da IA e campos estratégicos ───

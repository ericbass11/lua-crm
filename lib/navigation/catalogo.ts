...
export const NAV_CATALOG = [
  ...
  {
    // Módulo Cliente Oculto (fork Lua CRM): auditorias em que uma IA se passa
    // por cliente no WhatsApp da empresa avaliada + o funil de prospecção
    // gerado a partir dos laudos.
    href: "/app/mystery",
    label: "Cliente Oculto",
    description: "Auditorias de atendimento e o funil de prospecção gerado por elas.",
    icon: "ClipboardText",
    group: "analise",
    section: "O histórico que se consulta",
    minRole: "admin",
  ...
  {
    // Configurações exclusivas da instalação Lua CRM. Permanecem no catálogo
    // único para que sidebar, hubs e busca não deixem páginas órfãs.
    href: "/app/settings/followup",
    label: "Follow-up automático",
    description: "A sequência de retomada quando um cliente para de responder.",
    icon: "ClockCountdown",
    group: "organizacao",
    section: "Automação e integrações",
    minRole: "admin",
  },
  {
    href: "/app/settings/integrations",
    label: "Agenda Google",
    description: "A agenda usada pelos agentes para consultar horários e marcar reuniões.",
    icon: "Plugs",
    group: "organizacao",
    section: "Automação e integrações",
    minRole: "admin",

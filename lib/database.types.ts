  ...
  public: {
    Tables: {
      ...
      mystery_shopper_campaigns: {
        ...
        Relationships: [
          {
            foreignKeyName: "mystery_shopper_campaigns_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "mystery_shopper_campaigns_shopper_session_id_fkey"
            columns: ["shopper_session_id"]
            isOneToOne: false
            referencedRelation: "channel_sessions"
            referencedColumns: ["id"]
          },
      ...
      mystery_shopper_messages: {
        ...
        Relationships: [
          {
            foreignKeyName: "mystery_shopper_messages_campaign_id_fkey"
            columns: ["campaign_id"]
            isOneToOne: false
            referencedRelation: "mystery_shopper_campaigns"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "mystery_shopper_messages_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]

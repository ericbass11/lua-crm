...
export const ALVO_DE_FUNIL: Record<string, AlvoDeFunil> = {
  ...
  crm_set_lead_fields: "funil_vem_do_lead",
  ...
  crm_tag_conversation: "sem_funil",
  crm_schedule_meeting: "sem_funil",
  crm_reschedule_meeting: "sem_funil",
  crm_cancel_meeting: "sem_funil",

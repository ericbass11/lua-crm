      ...
      <div className="flex items-start justify-between gap-2">
        <div className="flex min-w-0 flex-1 items-center gap-3">
          ...
          <div className="min-w-0">
            ...
            {/*
              O modelo mostrado é o EM VIGOR (upstream 1.4.0), não o do
              cadastro: a versão publicada é quem atende o cliente, e a tela
              exibia o outro — dizendo "Publicado" sobre um modelo que o runtime
              não usa. O avatar e a tipografia são o design system Indigo desta
              instalação.
            */}
            <p

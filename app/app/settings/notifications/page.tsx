...
export default async function NotificationsPage() {
  ...
  return (
    <div className="flex h-full flex-col gap-6 p-6">
      ...
      {/* Extensão desta instalação: alertas de handoff por WhatsApp e webhook
          (tabela `notification_settings`, migration 0033). Convive com as
          preferências de Push do upstream — são canais diferentes. */}
      <HandoffWebhookCard />
    </div>
  );
}

  ...
  return (
    <>
      ...
      <div
        ...
        className="sticky bottom-4 z-30 mx-auto flex w-fit max-w-[calc(100vw-2rem)] flex-wrap items-center justify-center gap-2 rounded-full border border-border bg-surface-elevated px-4 py-2.5 shadow-lg"
      >
        <span className="px-1 text-sm font-semibold text-text">{rotuloDaContagem}</span>
